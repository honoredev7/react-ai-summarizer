                ...
                <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
                    {allArticles.map((item, index) => (
                        <div key={`link-${index}`} onClick={() => setArticle(item)} className="link_card">
                            ...
                            <p className="flex-1 font-satoshi text-blue-700 font-medium md:text-xl sm:text-lg truncate">
                                { item.url }
                            </p>
                        </div>
                    ))}
                    ...
                    article.summary && (
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="summary_box">
                                <p className="font-inter font-medium md:text-lg sm:text-sm text-gray-700">{article.summary}</p>
                            </div>
                        </div>
                    )
                )}
